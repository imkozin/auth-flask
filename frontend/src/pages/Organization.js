...
function Organization() {
  const { organizations, setOrganizations, refresh, setRefresh, setIsLoggedIn } =
        ...
        <div class="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
          <div className="w-full md:w-2/3 flex flex-col mb-2 items-center text-center">
            ...
            <p className="mb-8 leading-relaxed">
              ...
              Assumenda culpa, nobis possimus, dolor, nihil nemo vel incidunt
              perferendis natus pariatur voluptatibus doloribus veniam fuga
              quaerat ab sequi. Voluptas, cum eaque.
            </p>
        ...
        <div className="container px-5 py-12 mx-auto">
          <div className="flex flex-col text-center w-full mb-10">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              ...
              doloribus veniam eum, porro incidunt praesentium accusamus eius
              error numquam dolor saepe quia cumque a similique quos expedita
              explicabo adipisci?
            </p>
          </div>
